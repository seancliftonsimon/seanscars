...
const RawBallots = () => {
  ...
  const paginatedBallots = filteredBallots.slice(startIndex, startIndex + itemsPerPage);
            ...
            >
              ...
              >
                <div className="ballot-info">
                  <div className="ballot-id">{obfuscateClientId(ballot.clientId)}</div>
                  <div className="ballot-date">{formatDate(ballot.timestamp)}</div>
                  {ballot.flagged && <span className="flag-badge">Flagged</span>}
                </div>
